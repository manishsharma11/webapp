			...
			<div class="container">
				...
				<div id="no_buses_running" style="display: none;">
					...
					<div class="alert alert-info fade in" align="center">
									...
									<strong>Info!</strong> Bus services not started yet for today.....
					</div>
				
				</div> 
				<div id="map-canvas" style="width: 900px; height: 480px;"></div>
				
			</div>

	<input type="hidden" value="<c:out value="${admin.longitude }"></c:out>" id="long">
	  <input type="hidden" value="<c:out value="${admin.latitude }"></c:out>" id="lat">
