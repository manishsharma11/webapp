		...
		<div id="content">
			<div class="container">
				...
				<c:if test="${error=='routeExistError'}">
						<span style="color: #f00;"> Route name ${re.route_name } already exists please provide unique route name.......</span>
					</c:if>	
								...
								<form class="form-horizontal row-border" id="validate-4" action="updaterouteaction" method="post">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<input type="hidden" name="route_name_old" class="form-control required" value="<c:out value="${route.route_name }"></c:out>">
										</div>
									</div>
