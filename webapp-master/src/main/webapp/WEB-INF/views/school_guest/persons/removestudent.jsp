																...
																<div class="col-md-7">
																	<div class="widget box">
																		...
																		<div class="widget-content">
																			<form class="form-horizontal row-border" id="validate-4" action="removestudentaction" method="post">
																					
																					
																				<div class="form-group">
																					
																					<input type="hidden" name="id" value="<c:out value="${student.id }"></c:out>">
																					<input type="hidden" name="rfid_number" value="<c:out value="${student.rfid_number }"></c:out>">
																					...
																					<div class="col-md-9 clearfix">
																						...
																						<label for="chosen2" generated="true" class="has-error help-block" style="display:none;"></label>
																					</div>
																				</div>
																				<div class="form-group">
																				...
																				<div class="form-group">
																					...
																					<div class="col-md-9">
																						<c:if test="${student.ch1=='on' }">
																							<label class="checkbox"><input type="checkbox" name="ch1" class="uniform" checked="checked" disabled="disabled"> send text if emergency condition exists</label>
																						</c:if>
																						<c:if test="${student.ch1=='off' }">
																							<label class="checkbox"><input type="checkbox" name="ch1" class="uniform" disabled="disabled"> send text if emergency condition exists</label>
																						</c:if>
																						<c:if test="${student.ch2=='on' }">
																							<label class="checkbox"><input type="checkbox" name="ch2"  class="uniform" checked="checked" disabled="disabled"> send text  if child does not arrive at school</label>
																						</c:if>
																						<c:if test="${student.ch2=='off' }">
																							<label class="checkbox"><input type="checkbox" name="ch2"  class="uniform" disabled="disabled"> send text  if child doesnot arrive at school</label>
																						</c:if>
																						<c:if test="${student.ch3=='on' }">
																							<label class="checkbox"><input type="checkbox" name="ch3"  class="uniform" checked="checked" disabled="disabled"> send text  if bus is late</label>
																						</c:if>
																						<c:if test="${student.ch3=='off' }">
																							<label class="checkbox"><input type="checkbox" name="ch3"  class="uniform" disabled="disabled"> send text  if bus is late</label>
																						</c:if>
																						
																						<label for="sport" class="has-error help-block" generated="true" style="display:none;" ></label>
																					</div>
																					<input type="hidden" value="<c:out value="${student.rfid_number }"></c:out>" name="rfid_number_old">
																					<input type="hidden" value="<c:out value="${student.id }"></c:out>" name="id">
																					<input type="hidden" value="<c:out value="${student.bus_licence }" ></c:out>" name="bus_licence">
																				</div>
