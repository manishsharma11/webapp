								...
								<form class="form-horizontal row-border" id="validate-4"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<label class="control-label"> <c:out
												...
												class="form-control required"
												value="<c:out value="${driver.driver_rfid_number}"></c:out>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9 clearfix">
											<label class="control-label"> <c:out
													value="${driverInfo.driver_rfid_number }"></c:out>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<label class="control-label"> <c:out
													value="${driverInfo.phone_number }"></c:out>
											</label>
										</div>
									</div>
									...
									<div class="form-actions">
										<a type="button" class="btn btn-default"
											href="/sts/school_guest/persons/drivers">Back</a> 
									</div>
								</form>
							</div>
						</div>
