																...
																<div class="col-md-6">
																	<div class="widget box">
																		...
																		<div class="widget-content">
																			<form class="form-horizontal row-border" id="validate-4" action="removedriveraction" method="post">
																				
																				<div class="form-group">
																					<label class="col-md-3 control-label">RFID<span class="required">*</span></label>
																				...
																				<div class="form-group">
																					...
																					<div class="col-md-9">
																						<label class="control-label">
																							<c:out value="${driver.driver_name }"></c:out>
																						</label>
																						<input type="hidden" name="driver_id" class="form-control required"  value="<c:out value="${driver.id}"></c:out>">
																						<input type="hidden" name="driver_rfid_number" class="form-control required"  value="<c:out value="${driver.driver_rfid_number}"></c:out>">
																					</div>
																				</div>
																				<div class="form-group">
																					...
																					<div class="col-md-9">
																						<label class="control-label">
																							<c:out value="${driver.phone_number }"></c:out>
																						</label>
																					</div>
																				</div>
																				...
																				<div class="form-group">
																					...
																					<div class="col-md-9 clearfix">
																						<label class="control-label">
																							<c:out value="${driver.street }"></c:out>
																						</label>
																						<label for="chosen1" generated="true" class="has-error help-block" style="display:none;"></label>
																					</div>
																				</div>
																				...
																				<div class="form-group">
																					...
																					<div class="col-md-9 clearfix">
																						<label class="control-label">
																							<c:out value="${driver.state }"></c:out>
																						</label>
																						<label for="chosen1" generated="true" class="has-error help-block" style="display:none;"></label>
																					</div>
																				</div>
																				...
																				<div class="form-group">
																					...
																					<div class="col-md-9 clearfix">
																						<label class="control-label">
																							<c:out value="${driver.country }"></c:out>
																						</label>
																						<label for="chosen1" generated="true" class="has-error help-block" style="display:none;"></label>
																					</div>
																				</div>
