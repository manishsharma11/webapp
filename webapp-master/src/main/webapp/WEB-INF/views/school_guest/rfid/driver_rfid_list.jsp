		...
		<div id="content">
			<div class="container">
					...
					<div class="col-sm-6 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="value"><c:out value="${driver_rfid_list.size()}" /></div>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>Driver RFID List</h4>
				...
				<div class="alert alert-info fade in">
					...
					<strong>Info!</strong> RFIDs assigned to drivers are cannot be updated and deleted
				</div>
			</div>
			<!-- /.container -->
