		...
		<div id="content">
			<div class="container">
					...
					<div class="col-sm-6 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="value"><c:out value="${student_rfid_list.size()}" /></div>
				...
				<div class="alert alert-info fade in">
					...
					<strong>Info!</strong> RFIDs assigned to students are cannot be updated and deleted
				</div>
			</div>
			<!-- /.container -->
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<div class="form-group">
																<label class="col-md-8 control-label">Are you sure, delete Student RFID?</label>
																<br></br>
																<div class="col-md-8">
