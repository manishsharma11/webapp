							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-4" action="deletestopaction" method="post">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<label class="control-label"><c:out value="${stop.stop_name}"></c:out></label>
											...
											<input type="hidden" name="stop_number" 	class="form-control required" value="<c:out value="${stop.stop_number }"></c:out>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<label class="control-label"><c:out value="${stop.expected_time_towards_school}"></c:out></label>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<label class="control-label"><c:out value="${stop.expected_time_towards_home}"></c:out></label>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<label class="control-label"><c:out value="${stop.lattitude}"></c:out></label>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<label class="control-label"><c:out value="${stop.longitude}"></c:out></label>
