			...
			<div class="container">
				...
				<c:if test="${message== 'bus_exists' }">
					...
					<div class="alert alert-danger fade in">
						...
						<strong>Error!</strong> Bus already exists with Bus Licence Number: <b>${bus.bus_licence_number }</b>
					</div>
								...
								<form class="form-horizontal row-border" id="validate-4" action="addbusaction" method="post">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Bus Id<span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="bus_licence" value="${bus.bus_licence_number }" 	class="form-control required"  pattern="^\+?[A-Za-z0-9]+\*?$" id="bus_licencenumber" title="Licence Number Must be Alpha Numeric with no spaces">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Bus Make and Model <span class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="bus_make"  value="${bus.bus_make_model }" class="form-control required" pattern="^\+?[A-Za-z\ ]+\*?$" title="Make and Model must be characters with spaces">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-actions">
										<a type="button" class="btn btn-default"
											href="/sts/school_admin/bus/buses">Cancel</a> <input
