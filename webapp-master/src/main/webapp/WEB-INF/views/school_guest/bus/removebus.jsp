		...
		<div id="content">
			<div class="container">
				...
				<c:if test="${error=='studentsExists'}">
						...
						<strong>Error!</strong> Can not delete this bus.Students or staff alloted to this bus...
						</div>
				</c:if> 
								...
								<form class="form-horizontal row-border" id="validate-4" action="removebusaction" method="post">
									...
									<div class="form-group">
										...
										<div class="col-md-6 clearfix">
											...
											<label class="control-label"><c:out value="${bus.driver_name}"></c:out></label>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<input type="hidden" name="route_id" class="form-control required" id="driver_name" value="<c:out value="${bus.route_id}"></c:out>">
