	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
				...
				<!--=== Normal ===-->
				<div class="col-md-12">
					<a href="addstop?bus_id=<c:out value="${bus.id}"></c:out>" class="btn btn-primary"> <i
						class="icon-plus"></i> <span>Add New Stop</span>
					</a>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Stops List for Bus: 
									<font color="sienna"><c:out value="${bus.bus_licence_number}"></c:out></font>
									( Licence Number)
								</h4>
									...
									<tbody>
											<c:forEach items="${stops }" var="stop">
												...
												<tr>
													...
													<td>
														<a  href="updatestop?stop_id=<c:out value="${stop.id}"></c:out>&bus_id=<c:out value="${bus.id}"></c:out>" class="btn btn-sm btn-info"  > <i class=" icon-pencil"></i>&nbsp;Update</a>
														<a  href="deletestop?stop_id=<c:out value="${stop.id}"></c:out>&bus_id=<c:out value="${bus.id}"></c:out>"  class="btn btn-sm btn-danger" ><i class=" icon-trash"></i>&nbsp;Remove</a>
													</td>
												</tr>
