								...
								<table
									...
									<c:set var="x" value="0"></c:set>
												...
												<c:if test="${bus.bus_allotted  == 0 }">
													<tr class="context-menu-one box menu-1" data-toggle="collapse" >
														<td class="checkbox-column"><input type="checkbox"
															...
															type="hidden" value="${bus.bus_id}" id="busIdHidden">
														</td>
												</c:if>
											</c:if>
										...
										<c:out value="${bus.bus_licence_number}"></c:out> </a></td>
											...
											<td><c:out value="${bus.bus_id}"></c:out></td>  										
											<td><c:out value="${bus.bus_licence_number}"></c:out></td>  
											<td><c:out value="${bus.bus_make_model}"></c:out></td>
											<td><c:out value="${bus.bus_capacity}"></c:out></td>
											<td><c:out value="${bus.bus_allotted}"></c:out></td>											
											<td><c:out value="${bus.getDriver().getDriver_name()}"></c:out></td></tr>
										</c:forEach>
									</tbody>
								</table>
							</div>
