					...
					<div class="col-sm-6 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title">Total Persons</div>
								<div class="value">
									<c:out value="${totalPersons}"></c:out>
								</div>
						...
						<div class="widget box">
							...
							<div class="widget-content">
								<table
									...
									<tbody>
										<%int sno=0; %>
										<c:forEach items="${studentEntities }" var="studentEntities">
										<%sno=sno+1; %>
										<tr>
											<td><%=sno %></td>
											<td><c:out value="${studentEntities.student_name }"></c:out></td>
											<td><c:out value="Student"></c:out></td>
											<td><c:out value="${studentEntities.rfid_number }"></c:out></td>
											</tr>
										</c:forEach>
										<c:forEach items="${staffEntities }" var="staffEntities">
										<%sno=sno+1; %>
										<tr>
											<td><%=sno %></td>
											<td><c:out value="${staffEntities.staff_name }"></c:out></td>
											<td><c:out value="Staff"></c:out></td>
											<td><c:out value="${staffEntities.staff_rfid }"></c:out></td>
											</tr>
										</c:forEach>
