						...
						<div class="widget box">
							...
							<div class="widget-content">
								<form class="form-horizontal row-border"
									 id="validate-4"
									action="updatetripaction1" method="post">
									<input type="hidden" value="${trip.id}" name="id">
									<div class="form-group">
										<label class="col-md-3 control-label">Selected Trip Detail<span
											class="required">*</span></label>
										<div class="col-md-9 clearfix">
											<font color="sienna"  ><b>${trip.tripDetail.trip_display_name}</b></font>
										</div>
									</div>
									<div class="form-group">
									<label class="col-md-3 control-label">Enable? <span class="required">*</span></label>

										<c:if test="${trip.enabled == true }">
										...
										<c:if test="${trip.enabled == false }">

											<div class="col-md-9">
												<label class="radio"><input type="radio" name="enabled" value="true" class="required uniform" > Enable</label>
												<label class="radio"><input type="radio" name="enabled" value="false" class="uniform" checked="checked"> Disable
												</label>
										</div>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Date Running:</label>
										<div class="col-md-9">
											<font color="sienna"  ><b>${trip.trip_running_date}</b></font>
										</div> 
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Change:</label>
										<div class="col-md-9">
