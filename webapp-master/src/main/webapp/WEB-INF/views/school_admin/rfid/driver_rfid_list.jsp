											...
											if (rfid_number == ""
												...
												$
														.ajax({
															...
															url : "${pageContext.request.contextPath}/school_admin/rfid/driver/add",
															type : "POST",
															data : "rfid_number="
																	+ rfid_number,
															success : function(
											...
											if (rfid_number == ""
												...
												$
														.ajax({
															...
															url : "${pageContext.request.contextPath}/school_admin/rfid/driver/update",
															type : "POST",
															data : "current_rfid="
																	+ $(
																			"#rfid_number12")
										...
										function() {
											...
											$
													.ajax({
														...
														url : "${pageContext.request.contextPath}/school_admin/rfid/driver/delete",
														type : "POST",
														data : "rfid_number="
																+ rfid_number,
														success : function(
											...
											if (rfid_number == ""
												...
												$
														.ajax({
															...
															url : "${pageContext.request.contextPath}/school_admin/rfid/driver/search",
															type : "POST",
															data : "rfid_number="
																	+ rfid_number,
															success : function(
				...
				.contextMenu({
					...
					callback : function(key, options) {
						...
						if (key == "edit") {
							...
							jQuery("#rfid_update_click").trigger('click');
						...
						if (key == "delete") {
							...
							jQuery("#rfid_remove_click").trigger('click');
	...
	border-color: red;
				...
				<div class="page-header">
					...
					<div class="page-title">
						<h3>Drivers RFID</h3>
						<span>Create,Update,Delete Driver's RFID</span>
					</div>
					<br>
					...
					<div class="col-sm-6 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title">Total Drivers RFIDs</div>
								<div class="value">
									<c:out value="${driver_rfid_list.size()}" />
								</div>
				...
				<div class="col-md-12" align="right">
					...
					<a data-toggle="modal" href="#myModal4" class="btn btn-success"
						id="rfid_create_click"> <i class="icon-search"></i> <span>
							Search By RFID</span>
					</a> <a data-toggle="modal" style="display: none;" href="#myModal2"
						class="btn btn-success" id="rfid_update_click"> <i
						class="icon-search"></i> <span>edit</span>
					</a> <a data-toggle="modal" style="display: none;" href="#myModal3"
						class="btn btn-success" id="rfid_remove_click"> <i
						class="icon-search"></i> <span>edit</span>
					</a>
				</div>
				<br>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Driver RFID List
								</h4>
							...
							<div class="widget-content">
								<table
									...
									<tbody>
										<c:forEach var="rfid" items="${driver_rfid_list}">
											<c:choose>
											...
											<c:choose>
												...
												<c:otherwise>
													<td class="checkbox-column"><input type="checkbox"
														id="singleCheckId" class="uniform" disabled="disabled">
											...
											<td><c:if test="${rfid.available == 0}">
													<span class="label label-success">Available</span>
												</c:if> <c:if test="${rfid.available == 1}">
				...
				<div class="alert alert-info fade in">
					...
					RFIDs assigned to drivers are cannot be updated and deleted
				</div>
			</div>
			<!-- /.container -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Add new Driver RFID form:</h4>
				</div>
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="alert alert-danger fade in"
							...
							<strong>Error!</strong>RFID number
							must be in an Alpha-Numeric Pattern.
						</div>
						<div class="alert alert-danger fade in"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">Edit Driver RFID form:</h4>
				</div>
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="alert alert-danger fade in"
							...
							<strong>Error!</strong>Rfid Number allready available,Try Another ...
						</div>
						<div class="alert alert-danger fade in"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">Remove Driver RFID form:</h4>
				</div>
				<div class="modal-body">

					<div class="form-group">
						<label class="col-md-8 control-label">Are you sure to delete
							 below RFID?</label> <br></br>
						<div class="col-md-8">

							<button class="btn" id="rfid_number12_delete"></button>
						...
						<div class="alert alert-danger fade in"
							...
							<strong>Error!</strong>RFID number
							must be in an Alpha-Numeric Format.
						</div>
						<div class="alert alert-danger fade in"
							id="rfid_number_status_error21" style="display: none;">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="alert alert-danger fade in"
							...
							<i class="icon-remove close" data-dismiss="alert"></i> <strong>Error!</strong>
							Please enter RFID number (RFID number must be Alpha-Numeric)
						</div>
						<div class="alert alert-danger fade in"
							id="rfid_number_status_error111" style="display: none;">
							<i class="icon-remove close" data-dismiss="alert"></i> <strong>Error!</strong>
							RFID number between 10-20 only
						</div>
						<div class="alert alert-danger fade in"
							id="rfid_number_status_error2" style="display: none;">
							<i class="icon-remove close" data-dismiss="alert"></i> <strong>Error!</strong>
