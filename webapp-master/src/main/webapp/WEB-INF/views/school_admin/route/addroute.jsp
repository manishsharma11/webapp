							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-4" action="addrouteaction" method="post">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="route_name" class="form-control required" minlength="1" id="routeName" value="${route.route_name}">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Route Display Name<span class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="display_name" class="form-control required" minlength="1" id="routeDisplayName" value="${route.display_name}">
										</div>
									</div>									
									<div class="form-group">
