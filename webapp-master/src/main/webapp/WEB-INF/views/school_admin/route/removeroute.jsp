					...
					<div class="col-md-7">
						<div class="widget box">
							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-4" action="removerouteaction" method="post">
									...
									<div class="form-group">
										<label class="col-md-6 control-label">
											Route Name:
											<span class="required"><c:out value="${route.route_name }"></c:out></span>
										</label>
										<div class="col-md-9">
									...
									<div class="form-actions">
										<a type="button" class="btn btn-default"
											...
											class="btn btn-sm btn-danger pull-right" id="add_new_driver_action">
									</div>
								</form>
							</div>
						</div>
