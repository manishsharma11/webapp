...
<head>
	...
	<script type="text/javascript" src="<c:url value="/resources/project_js_file/capsLockForRoles.js" /> "></script> 
	<script type="text/javascript" src="<c:url value="/resources/project_js_file/changepasswordOfUsers.js" />"></script>	
	<!-- Include CSS files -->
							...
							<div class="statbox widget box box-shadow">
								...
								<div id="current_password" >
										...
										<div class="col-md-6">
											...
											<div id="error">
												<div>																		
													<i class="icon-warning-sign (&#xf071;)"></i> <b> Caps Lock is ON.</b>		
												</div>
											</div>
											
											
											<!-- <span id="error" style="font-weight: bold">Caps Lock is ON.</span> -->
										...
										<a type="button" class="btn btn-default"
											href="/sts/school_admin/roles/change">Cancel</a>
										</div>
										<!-- mycode -->
										...
										<a type="button" class="btn btn-default"
											href="/sts/school_admin/roles/change">Cancel</a> -->
											<input id="userCssId" type="hidden" value="${userId}">
										<br><br><br>
								...
								<div id="new_password" style="display: none;">
										...
										<div class="col-md-6">
											...
											<input type="password" id="c_password_new" name="c_password_new" class="form-control required" >
										...
										<!-- <span id="error1" style="font-weight: bold">Caps Lock is ON.</span> -->
										<label class="col-md-4 control-label"></label>
										<div class="col-md-6">																						
											<div class="col-md-8">
												<!-- <i class="icon-warning-sign (&#xf071;)"></i> <b> Caps Lock is ON.</b> -->
												<span id="error1" style="font-weight: bold"><i class="icon-warning-sign (&#xf071;)"></i>Caps Lock is ON.</span><br><br>
											</div>		
								...
								<a type="button" class="btn btn-default"
											href="<%=request.getContextPath()%>/school_admin/roles/change">Back</a>
								</div>								
								</div>								
							</div> <!-- /.smallstat -->
					</div> <!-- /.col-md-3 -->					
