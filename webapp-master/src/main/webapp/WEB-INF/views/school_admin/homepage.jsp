					...
					<br>
						<script>
							function myFunction(status) {
								alert(status);
							   // var myWindow = window.open("notificationspage", "www.google.com", "width=800, height=600");
							    /* window.open('notificationspage', 'popup_name','height=' + 600 + 
										',width=' + 900+ ',resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no'); */
							}
						</script>
					<!--=== Statboxes ===-->
					...
					<div class="col-sm-3 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title">
									<a href="#" onclick="window.open('homepage/notificationspage?status=ontime', 'popup_name','height=' + 600 + 
										',width=' + 900+ ',resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no');"  >Buses On Time </a>
					...
					<div class="col-sm-5 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title">
									<a href="#" onclick="window.open('homepage/notificationspage?status=late', 'popup_name','height=' + 600 + 
										',width=' + 900+ ',resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no');"  >Buses  Late </a>
								</div>
					...
					<div class="col-sm-5 col-md-3 hidden-xs">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title">
									<a href="#" onclick="window.open('homepage/notificationspage?status=verylate', 'popup_name','height=' + 600 + 
										',width=' + 900+ ',resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no');"  >Buses Very Late </a>
								</div>
					...
					<div class="col-sm-5 col-md-3 hidden-xs">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title"><a href="#" onclick="window.open('homepage/notificationspage?status=outofservice', 'popup_name','height=' + 600 + 
										',width=' + 900+ ',resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no');"  >Buses Out of Service</a></div>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															...
															<h4 class="modal-title">Bus Information:</h4>
														</div>
														<div class="modal-body" style="overflow: scroll;">
														
																<ul class="feeds clearfix" id="notifications">
