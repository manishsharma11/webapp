...
<html>
        	   ...
        	   setInterval(function() {
        		  // alert($("#session").val());
		  			$.ajax({
		  				...
		  				url:"map/getSingleBusMapData",
		  				type:"POST",
		  				data:"bus_id="+$("#bus_id").val()+"&trip_id="+$("#trip_id").val(),
   ...
   <input type="hidden" value="<c:out value="${trip_id }"></c:out>" id="trip_id">
   <input type="hidden" value="<c:out value="${school_longitude }"></c:out>" id="long">
   <input type="hidden" value="<c:out value="${school_latitude }"></c:out>" id="lat">
</html>