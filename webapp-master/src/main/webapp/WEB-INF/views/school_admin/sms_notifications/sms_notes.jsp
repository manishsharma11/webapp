							...
							<div class="widget-content">
								<div class="tabbable tabbable-custom">
									<ul class="nav nav-tabs">
										...
										<li><a href="#tab_feed_2" data-toggle="tab">App Notifications</a></li>
										<li><a href="#tab_feed_3" data-toggle="tab">SMS Notifications</a></li>
									</ul>
									<div class="tab-content">
										...
										<div class="tab-pane" id="tab_feed_3">
											<div class="scroller" data-height="450px" data-always-visible="1" data-rail-visible="0">
													...
													<textarea id="sms_message" rows="5" cols="5" name="textarea" style="overflow:scroll;" class="auto form-control"></textarea>
													</br>
													<button class="btn btn-info" id="send_sms">Send SMS</button>
												</div>
											</div> <!-- /.scroller -->
										</div> <!-- /#tab_feed_1 -->
									</div> <!-- /.tab-content -->
