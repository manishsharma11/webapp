<!--=== JavaScript ===-->
	...
	<script type="text/javascript" src="<c:url value="/resources/plugins/duallistbox/jquery.duallistbox.min.js" />"></script>
	...
	<%-- <script type="text/javascript" src="<c:url value="/resources/project_js_file/list_dropdown.js" />"></script> --%>
	...
	<%-- <script type="text/javascript" src="<c:url value="/resources/project_js_file/notifications.js" />"></script> --%>
	<!-- General -->
	...
	<script type="text/javascript" src="<c:url value="/resources/plugins/typeahead/typeahead.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/fileinput/fileinput.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/duallistbox/jquery.duallistbox.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/bootstrap-inputmask/jquery.inputmask.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/bootstrap-wysihtml5/wysihtml5.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/bootstrap-multiselect/bootstrap-multiselect.min.js" />"></script>
	...
	<!-- Pickers -->
	<script type="text/javascript" src="<c:url value="/resources/plugins/pickadate/picker.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/pickadate/picker.date.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/pickadate/picker.time.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/plugins/bootstrap-colorpicker/bootstrap-colorpicker.min.js" />" ></script>
	...
	<!--Export js-->
	<script type="text/javascript" src="<c:url value="/resources/plugins/exporttable/jquery.base64.js " />"></script>
	 
	<script type="text/javascript" src="<c:url value="/resources/plugins/exporttable/tableExport.js " />"></script>
	
	<script type="text/javascript" src="<c:url value="/resources/plugins/exporttable/base64.js " />"></script>
	
	<script type="text/javascript" src="<c:url value="/resources/plugins/exporttable/jspdf.js " />"></script>
	
	<script type="text/javascript" src="<c:url value="/resources/plugins/exporttable/sprintf.js " />"></script>
	...
	<script type="text/javascript" src="<c:url value="/resources/assets/js/demo/ui_general.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/assets/js/demo/form_validation.js" />"></script>
	<!-- Right Click options -->
	<script src="<c:url value="/resources/src/jquery.ui.position.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/src/jquery.contextMenu.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/src/screen.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/src/prettify.js" />" type="text/javascript"></script>
    
    <link href="<c:url value="/resources/src/jquery.contextMenu.css" />" rel="stylesheet" type="text/css" />
   <%--  <link href="<c:url value="/resources/src/screen.css" />" rel="stylesheet" type="text/css" /> --%>
    <link href="<c:url value="/resources/src/prettify.sunburst.css" />" rel="stylesheet" type="text/css" />
