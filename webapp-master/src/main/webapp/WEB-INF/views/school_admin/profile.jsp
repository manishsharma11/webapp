												...
												<div class="widget-content">
													<form class="form-horizontal row-border" id="validate-2" 	action="changepassword" method="get">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;"  class="col-md-6"><c:out value="${admin_profile.full_name }"></c:out></label>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${admin_profile.user_name}"></c:out></label>
															</div>
														</div>
														<%-- <div class="form-group">
											...
											<div class="widget box">
												...
												<div class="widget-content">
													<form class="form-horizontal row-border" id="validate-1" 	action="updateprofile" method="post">
														<input type="hidden" name="user_id" value="${admin_profile.user_id}">
														<input type="hidden" name="access_status" value="${admin_profile.access_status}">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="full_name" minlength="3"
																	class="form-control required"
																	pattern="^\+?[A-Za-z\ ]+\*?$"
																	value="<c:out value="${admin_profile.full_name }"></c:out>"
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="user_name"
																	class="form-control required"
																	pattern="^\+?[A-Za-z0-9]+\*?$"
																	value="<c:out value="${admin_profile.user_name}"></c:out>"
