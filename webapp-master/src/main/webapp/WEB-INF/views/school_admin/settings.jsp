		...
		$("#email_add_button").click(function(){	
			...
			if(!(pattern.test(email))){				
				...
				$("#rfid_number_status_error501").show();											
				 ...
				 $.ajax({				
					url:"${pageContext.request.contextPath}/school_admin/settings/adminemail/add",
					type:"POST",
					data:'email='+email,
...
$(function(){
    $.contextMenu({
        ...
        /*  if(key=="edit"){      
         ...
         if(key=="delete"){        	         	 
        	 //alert(va);
             window.location="adminemail/delete?id="+va;
         }
        },
        items: {
			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li><i class="icon-user"></i> Settings</li>
										...
										<div class="col-md-12">
											<div class="widget box">
												<div class="widget-header">
													<h4>
														<i class="icon-reorder"></i> Dashboard Settings
													</h4>
												</div>
												<div class="widget-content">
													<form class="form-horizontal row-border" id="validate-2" 	action="changepassword" method="get">
														...
														<%-- <div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.number }"></c:out></label>
															</div>
														</div> --%>
														...
														<div class="form-group">
															...
															&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEasy Commute Coordinates</p></b>
															</font>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;"  class="col-md-3"><c:out value="${dashBoardSettings.school_latitude }"></c:out></label>
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-3 control-label">Longitude:</label>
															<div class="col-md-9">
																<label  style="color: sienna;"  class="col-md-3"><c:out value="${dashBoardSettings.school_longitude }"></c:out></label>
															</div>
														</div>
														<div class="form-group">
														<font color="#000000">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.phone_number_alerts }"></c:out></label>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.smtp_server_host }"></c:out></label>
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-3 control-label">SMTP Port </span></label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.smtp_port }"></c:out></label>
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-3 control-label">From Mail </label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.from_email }"></c:out></label>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.school_name }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Customer Care Number
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.customer_care_number }"></c:out></label>
															</div>
														</div>
														...
														<div class="form-group">
															<label class="col-md-3 control-label">About Us
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-12"><c:out value="${dashBoardSettings.about_us}"></c:out></label>
															</div>
														</div>
														...
														<div class="form-group">
															<label class="col-md-3 control-label">Referral Scheme Describe
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-12"><c:out value="${dashBoardSettings.referral_scheme_desc}"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Customer Care Email
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.customer_care_email }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">WhatsApp Care Number
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.whatsapp_care_number }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Current App Version
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.current_app_version }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Version Check Update Message
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-12"><c:out value="${dashBoardSettings.version_check_update_message }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Trip Weekend Exclusion Check
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.trip_weeekend_exclusion_check_enabled }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Offer Announcement Message
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-12"><c:out value="${dashBoardSettings.offer_announcement_message }"></c:out></label>
															</div>
														</div>
														
														<div class="form-group">
															<label class="col-md-3 control-label">Offer Announcement Enabled
															</label>
															<div class="col-md-9">
																<label  style="color: sienna;" class="col-md-3"><c:out value="${dashBoardSettings.offer_announcement_enabled}"></c:out></label>
															</div>
														</div>
									...
									<div class="row">
										...
										<div class="col-md-7">
											<div class="widget box">
												...
												<div class="widget-content">
													<form class="form-horizontal row-border" id="validate-1" 	action="update" method="post">
														<%-- <div class="form-group">
														...
														<%-- <div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="number"
																	class="form-control required"
																	pattern="^\+?[0-9\-]+\*?$"
																	value="<c:out value="${dashBoardSettings.number }"></c:out>"
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="school_latitude"
																	value="<c:out value="${dashBoardSettings.school_latitude }"></c:out>"
														...
														<div class="form-group">
															<label class="col-md-3 control-label">Longitude<span
																class="required">*</span></label>
															<div class="col-md-9">
																<input type="text" name="school_longitude"
																value="<c:out value="${dashBoardSettings.school_longitude }"></c:out>"
																	class="form-control required" range="-90, +90">
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="phone_number_alerts"
																	class="form-control required"
																	pattern="^\+?[0-9\-]+\*?$"
																	value="<c:out value="${dashBoardSettings.phone_number_alerts }"></c:out>"
																	title="phone number must be numbers with symbols(+,-)">
															</div>
														</div>
														...
														<div class="form-group">
															<label class="col-md-3 control-label">SMTP Serverhost <span
																class="required">*</span></label>
															<div class="col-md-9">
																<input type="text" name="smtp_server_host"
																	class="form-control required" value="<c:out value="${dashBoardSettings.smtp_server_host }"></c:out>">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="smtp_port"
																	class="form-control required" value="<c:out value="${dashBoardSettings.smtp_port }"></c:out>">
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="from_email"
																	value="<c:out value="${dashBoardSettings.from_email }"></c:out>"
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																value="<c:out value="${smtp_password}"></c:out>"
