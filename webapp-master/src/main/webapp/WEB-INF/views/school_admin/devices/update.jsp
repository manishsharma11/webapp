					...
					<div class="col-md-6">
						<div class="widget box">
							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-4" action="updateaction" method="post">

									
									<input type="hidden" name="old_ec_device_id" value="${device.ec_device_id }" 	class="form-control required" >
									
									<div class="form-group">
										<label class="col-md-3 control-label">Device ID<span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="ec_device_id" value="${device.ec_device_id }" 	class="form-control required"  pattern="^\+?[A-Za-z0-9]+\*?$" id="bus_licencenumber" title="Please enter device ID">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="vehicle_id"  value="${device.vehicle_id }" class="form-control required number"  title="Please enter Vehicle ID and only numbers">
										</div>
									</div>
