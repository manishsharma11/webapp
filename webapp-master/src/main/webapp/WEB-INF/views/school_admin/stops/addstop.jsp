						...
						<div class="widget box">
							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-4"
									action="addstopaction" method="post">
									...
									<c:if test="${error_message=='latAndLongDup'}">
										<div>
											<i data-dismiss="alert"></i> <font color="sienna">
												Latitude and Longitude are already available</font>
										</div>
									</c:if>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Shortcode<span
											class="required">*</span></label>
										<div class="col-md-9">
											<input type="text" name="shortcode"
												class="form-control required" value="${stop.shortcode}"
												pattern="^[a-zA-Z]*$" title="shortcode must be combinations of Alpha characters">
										</div>
									</div>
									<div class="form-group">
