			...
			<div class="container">
				...
				<div class="page-header">
					...
					<div class="page-title">
						<h3>Settings</h3>
						<span>Create,Update,Delete Settings</span>
					</div>
					<br>
					...
					<div class="col-sm-6 col-md-3">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<div class="title">Total Settings</div>
								<div class="value">
									<c:out value="${settings.size()}"></c:out>
								</div>
							</div>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i>Settings List
								</h4>
								...
								<table
									...
									<thead>
										...
										<tr>
											...
											<th>Phone Number Alerts</th>
											<th>School Name</th>
											<th>Customer Care Number</th>
											<th>About Us</th>
											<th>Referral Scheme Description</th>
											<th>Customer Care Email</th>
											<th>WhatsApp Care Number</th>
											<th>Current App Version</th>
											<th>Version Check Update Message</th>
											<th>Trip Weekend Exclusion Check</th>
											<th>Offer Announcement Message</th>
											<th>Offer Announcement Enabled</th>
										</tr>
									</thead>
									...
									<tbody>
										...
										<tr class="context-menu-two box menu-1">
											<td><c:out value="${settings.id}"></c:out></td>
											<td><c:out value="${setting.id}"></c:out></td>
											<td><c:out value="${setting.commuter_name}"></c:out></td>
											<td><c:out value="${setting.mobile}"></c:out></td>
											<td><c:out value="${setting.gender}"></c:out></td>
											<td><c:out value="${setting.from_stop_name}"></c:out></td>
											<td><c:out value="${setting.to_stop_name}"></c:out></td>
											<td><c:out value="${setting.setting_travel_date}"></c:out></td>
											<td><c:out value="${setting.num_seats_booked}"></c:out></td>
											<td><c:out value="${setting.trip_name}"></c:out></td>
											<td><c:out value="${setting.trip_type}"></c:out></td>
											<td><c:out value="${setting.setting_cancellation_date}"></c:out></td>
											<td><c:out value="${setting.setting_time}"></c:out></td>
											<td><c:out value="${setting.commuter_id}"></c:out></td>
