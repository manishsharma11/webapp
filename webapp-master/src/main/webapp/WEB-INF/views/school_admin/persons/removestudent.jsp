					...
					<div class="col-md-12">
						<div class="widget box">
							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-499" action="removestudentaction" method="post">
								...
								<div class="row">
									...
									<div class="form-actions">
										<a type="button" class="btn btn-default"
											href="/sts/school_admin/persons/students">Cancel</a>
									    <a href="removestudentaction?id=${student.id }" class="btn btn-danger pull-right" >Delete</a>
									</div>
