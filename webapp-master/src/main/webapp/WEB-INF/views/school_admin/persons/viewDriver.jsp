								...
								<form class="form-horizontal row-border" id="validate-4"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<label class="control-label" style="color: sienna"> <c:out
													value="${driverInfo.driver_name }"></c:out>
											</label> <input type="hidden" name="driver_id"
												class="form-control required"
												value="<c:out value="${driver.id}"></c:out>"> <input
												type="hidden" name="driver_rfid_number"
												class="form-control required" style="color: sienna"
												value="<c:out value="${driver.rfid_number}"></c:out>">
										</div>
									</div>

									<div class="form-group">
										<label class="col-md-3 control-label">Driver Id<span
											class="required">*</span></label>
										<div class="col-md-9">
											<label class="control-label" style="color: sienna"> <c:out
													value="${driverInfo.driver_id }"></c:out>
											</label>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9 clearfix">
											<label class="control-label" style="color: sienna"> <c:out
													value="${driverInfo.rfid_number }"></c:out>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<label class="control-label" style="color: sienna"> <c:out
													value="${driverInfo.contact_number }"></c:out>
											</label>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9 clearfix">
											<label class="control-label" style="color: sienna"> <c:out
													value="${driverInfo.country }"></c:out>
											</label> <label for="chosen1" generated="true"
												class="has-error help-block" style="display: none;"></label>
										</div>
									</div>
									...
									<div class="form-actions">
										<a type="button" class="btn btn-default"
											href="<%=request.getContextPath()%>/school_admin/persons/drivers">Back</a> 
									</div>
								</form>
							</div>
						</div>
