		...
		<div id="content">
			<div class="container">
				...
				<c:if test="${error=='staffidExistError'}">
						...
						<strong>Error! </strong> <span> Staff ID already exists please provide unique StaffId</span>
						</div>
						<style>
							#home_error{
					...
					<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-8 clearfix">
											<input type="text" name="mobile"
												...
												pattern="^\+?[0-9\-]+\*?$"
												title="phone number must be numbers with symbols(+,-) and range should between 8-12 " value="${staff.mobile}">
										</div>
									</div>
									<div class="form-group">
						...
						<div class="widget box">
							...
							<div class="widget-content">
													<div class="form-group">
														...
														<div class="col-md-8 clearfix">
															<input type="text" name="street"
																class="form-control required" value="${staff.street}">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-8 clearfix">
															<input type="text" name="city"
																class="form-control required" value="${staff.city}">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-8 clearfix">
															<input type="text" name="state"
																class="form-control required" value="${staff.state}">
														</div>
													</div>
													<div class="form-group">
												...
												title="postal must be alphanumeric" value="${staff.postal}">
														</div>
													</div>
													<div class="form-group">
						...
						<!-- /Validation Example 1 -->
									...
									<c:if test="${message== 'fromHome-error' }">
										...
										<div class="alert alert-danger fade in">
											...
											There are no seats available from home route: <b>${routeFromHome}</b>
										</div>
									...
									<c:if test="${message== 'fromSchool-error' }">
										...
										<div class="alert alert-danger fade in">
											<i class="icon-remove close" data-dismiss="alert"></i> <strong>Error!</strong>
											There are no seats available from school route: <b>${routeFromSchool}</b>
										</div>
												...
												<div class="widget-header">
													<h4>
														...
														<label class="checkbox-inline">
															<input type="checkbox" class="uniform" id="take_bus_fromhome"> Take Bus
														</label>
													</h4>
												</div>
												<div class="widget-content">
											...
											<div class="widget box">
												<div class="widget-header">
													<h4>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label class="checkbox-inline">
															<input type="checkbox" class="uniform" id="take_bus_fromschool"> Take Bus
														</label>
													</h4>
												</div>
												<%-- --%>
