							...
							<div class="widget-content">
								<form class="form-horizontal row-border" id="validate-4"
									...
									<input type="hidden" name="fare_id"
										value="${busFarePriceEntity.fare_id}"
									...
									<div class="form-group">
										...
										<div class="col-md-9 clearfix">
											<select name="source_stop_id"
												...
												<option value="${busFarePriceEntity.source_stop.id }">${busFarePriceEntity.source_stop.stop_name }</option>
									...
									<div class="form-group">
										...
										<div class="col-md-9 clearfix">
											<select name="dest_stop_id"
												...
												<option value="${busFarePriceEntity.source_stop.id }">${busFarePriceEntity.dest_stop.stop_name }</option>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="bus_fare"
												value="${busFarePriceEntity.bus_fare}"
												class="form-control required" pattern="^\+?[0-9\-]+\*?$"
												id="bus_licencenumber"
												title="Licence Number Must be Alpha Numeric with no spaces">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="auto_fare"
												value="${busFarePriceEntity.auto_fare}"
												class="form-control required" pattern="^\+?[0-9\-]+\*?$"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="actual_fare"
												class="form-control required digits"  value="${busFarePriceEntity.actual_fare}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="charged_fare"
												class="form-control required digits"  value="${busFarePriceEntity.charged_fare}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="discounted_fare"
												class="form-control required digits"  value="${busFarePriceEntity.discounted_fare}">
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="distance"
												value="${busFarePriceEntity.distance}" class="form-control required"
												pattern=""
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="time_duration"
												value="${busFarePriceEntity.time_duration}" class="form-control required"
												pattern=""
									...
									<div class="form-actions">
										<input type="submit" value="Update Fare Price"
